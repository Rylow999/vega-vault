...
**Verificación empírica (100 seeds × 2000 pasos):**
...
### Resumen de Valores Verificados (100 Seeds × 2000 Pasos)
...
- **Resultado**: 100/100 semillas convergen ($\rho_{\text{eff}} = 0.7001 \pm 0.002$)
...
|---------|---------------------|---------------|----------------|-----------------|
| **T1: Vitalidad** | 100 / 100 | $\rho_{\text{eff}}$ | > 0.65 | **0.7001** ± 0.002 |
| **T2: Norma ω** | 100 / 100 | max $\|\omega\|$ | < 1.111 | **1.087** |
| **T3: Fase** | 97 / 100 | $\omega_{\text{sim}}$ | > 0.5 | **0.612** ± 0.045 |

### 13.5 Distribución de $\rho_{\text{eff}}$ (Tiempo Subjetivo Efectivo)
...
|---------|-------|-------------|
| Nodos activos | 4.0 ± 0.0 | Teorema 1: N* = 4 (ρ_eff/θ_death = 7.00, bound 10) |
...
### 15.5 Activación C3 (Phase-Hijacking)
...
#### **C3 — Phase-Hijacking por Valencia** (RETIRADO en Ronda 6, 2026-07-24 — NO SOSTENIDO a parámetros originales: 0.9% triggers, ΔPLV≈0; rediseño llega a 30.2%, lejos de "la norma". Se mantiene como Predicción histórica, no como claim activo)
