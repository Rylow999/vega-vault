...
ALPHA=5.0; BETA=0.20; GAMMA=0.01; THETA_DEATH=0.10; D=8; K=10; N_INIT=1000
...
class Engine:
    ...
    def _chain_step(self,src):
        ...
        return act[-1]
    def _rho(self,act):
        # densidad: fraccion de pares activos con afinidad>0.5
...
def run(ctx,steps=1500,seeds=8):
    Ns=[]; Al=[]
...
def main():
    print("=== v0.4 beta_eff contextual (K=10, N=1000) ===")
