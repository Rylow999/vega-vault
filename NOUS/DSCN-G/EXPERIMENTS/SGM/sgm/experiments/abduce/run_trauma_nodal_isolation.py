...
def attraction_local(nodes, M, trauma_id, act_trauma, k=K):
...
def main():
    ...
    scoreB = 0.0
    aislamiento_ok = (scoreB == 0.0) and (omega_respaldo == nodes[TRAUMA_ID]["omega"])
    ...
    result = {
        ...
        "result":{
            ...
            "B_aislamiento":{"score":scoreB,"omega_preservado":(omega_respaldo==nodes[TRAUMA_ID]["omega"]),"aislamiento_ok":aislamiento_ok},
    ...
    print("  B aislamiento score:", scoreB, "omega preservado:", (omega_respaldo==nodes[TRAUMA_ID]["omega"]), "-> ok:", aislamiento_ok)
